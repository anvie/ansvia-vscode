...
import { window, ExtensionContext, commands, Uri, Range, Position } from 'vscode';
...
export function setup(context: ExtensionContext) {
    context.subscriptions.push(commands.registerCommand('extension.flutter', async () => {
        ...
        quickPick.items = [
            ...
            new Cmd("Generate Class variables and constructor CVC1 (+final)", () => generateClassVarAndConstructor(true, false)),
            new Cmd("Generate Class variables and constructor CVC1b (+final, +required)", () => generateClassVarAndConstructor(true, false, true)),
            ...
            new Cmd("Generate Class variables and constructor CVC4 (+final, notopt) ", () => generateClassVarAndConstructor(true, false, false, true)),
        ];
